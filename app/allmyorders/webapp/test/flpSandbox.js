		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "All my Orders",
									"targetURL": "#ordermonitoringallmyorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordermonitoringallmyorders-display": {
								"semanticObject": "ordermonitoringallmyorders",
								"action": "display",
								"description": "All my Orders (Freestyle)",
								"title": "All my Orders",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordermonitoring.allmyorders",
									"url": sap.ui.require.toUrl("ordermonitoring/allmyorders")
								}
							}
						}
					}
